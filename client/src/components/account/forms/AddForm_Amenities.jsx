...
// components
import AddForm_AmenitiesSelector from "./AddForm_AmenitiesSelector";

const AddForm_Amenities = ({ formInfo, setFormInfo }) => {
  return (
...
export default AddForm_Amenities;
